...
class TCustomCurvedEdges extends CustomClipper<Path> {
  ...
  Path getClip(Size size) {
    ...
    path.quadraticBezierTo(secondPoint.dx, secondPoint.dy, secondLastPoint.dx, secondLastPoint.dy);

    final thirdPoint = Offset(size.width, size.height - 20);
    final thirdLastPoint = Offset(size.width, size.height);
    path.quadraticBezierTo(thirdPoint.dx, thirdPoint.dy, thirdLastPoint.dx, thirdLastPoint.dy);
